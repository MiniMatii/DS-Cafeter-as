...
|Req|Detalle|
|:-|:-|
|CRUD simple|1. CRUD Usuario<br>2. CRUD Zona<br>3. CRUD Servicio|
|CRUD dependiente|1. CRUD  Cafeteria {depende de} CRUD Usuario y CRUD Zona<br>2. CRUD Producto {depende de} CRUD Cafeteria<br>3. CRUD Reseña {depende de} CRUD Usuarios y CRUD Cafeteria|
...
|Req|Detalle|
|:-|:-|
|CRUD |1. CRUD Usuario<br>2. CRUD Zona<br>3. CRUD Servicio<br>4. CRUD Cafetería<br>5. CRUD Producto<br>6. CRUD Reseña<br>7. CRUD Favoritos|
