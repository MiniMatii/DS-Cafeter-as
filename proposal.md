...
|CRUD dependiente|1. CRUD  Cafeteria {depende de} CRUD Usuario y CRUD Sucursal<br>2. CRUD Producto {depende de} CRUD Cafeteria<br>3. CRUD Cartas {depende de} CRUD Producto y CRUD Cafeterias
